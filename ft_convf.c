...
/*   Updated: 2019/02/11 12:53:12 by mde-laga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_size(t_prin *prin, int neg)
{
	int size;
...
char		*ft_prefix(t_prin *prin, char *str, int neg)
{
	char	*pre;
	int		size;
	int		nlen;
...
char	*ft_suffix(t_prin *prin, char *ret)
{
	char	*suf;
	int		i;
	int		len;
